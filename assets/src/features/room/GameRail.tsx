...
export default function GameRail({
  ...
  return (
    <nav
      ...
      className="flex w-full shrink-0 items-stretch gap-1.5 overflow-x-auto border-line bg-void max-xl:border-b max-xl:p-1.5 xl:h-[calc(100dvh-3.5rem)] xl:w-[260px] xl:flex-col xl:gap-0 xl:overflow-x-visible xl:border-r"
    >
