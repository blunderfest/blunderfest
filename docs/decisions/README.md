...
| [0037](adr-0037-packed-occurrence-backend.md) | Packed binary occurrence backend behind the `Corpus` facade (`occurrence_backend` config): parity exact, product parity correct, PG still provisionable while broadcast validates | Accepted (2026-08-31) |
