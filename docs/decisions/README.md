...
| [0028](adr-0028-room-persistence-anonymous-identity-and-retention.md) | Room persistence: what the durable op log stores, author identity (name snapshots), 1h retention, privacy posture | Proposed (2026-08-26) |
